...
import { Sprout, Mail, Lock, User, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="flex-1 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md glass-card rounded-3xl p-8 border border-slate-700/60 shadow-2xl relative overflow-hidden animate-fade-in">
        ...
        <div className="text-center mb-8 relative">
          ...
          <h2 className="font-outfit text-2xl md:text-3xl font-extrabold text-white">Create Account</h2>
          <p className="text-slate-400 text-sm mt-1">Start optimizing your crop yield today</p>
        </div>
        ...
        <div className="mt-8 text-center text-slate-400 text-xs relative">
          ...
          <Link to="/login" className="text-nature-400 hover:text-nature-300 font-semibold underline">
            Log in here
          </Link>
        </div>
      </div>
